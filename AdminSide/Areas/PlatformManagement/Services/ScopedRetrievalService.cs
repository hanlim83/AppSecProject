...
{
    internal class ScopedRetrievalService : IScopedRetrievalService
    {
        ...
        public ScopedRetrievalService(ILogger<ScopedRetrievalService> logger, PlatformResourcesContext Context, IAmazonEC2 EC2Client, IAmazonCloudWatch cloudwatchClient, IAmazonCloudWatchEvents cloudwatcheventsClient, IAmazonCloudWatchLogs cloudwatchlogsClient)
        {
            _logger = logger;
            context = Context;
            ec2Client = EC2Client;
